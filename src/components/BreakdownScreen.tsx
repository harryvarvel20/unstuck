          ...
          <section className="mb-6">
            ...
            {status !== "loading" && status !== "streaming" && (
              <>
                ...
                {/* Navigator entry (Y2): unmistakably a link to the tools, not
                    an input — hairline card, leading compass, trailing chevron.
                    Secondary in weight to the primary "Make it doable". */}
                <a
                  href="/toolkit"
                  aria-label="Open the Toolkit — all your tools"
                  onClick={() => capture("navigator_opened")}
                  className="group mt-3 flex items-center gap-3 rounded-2xl border border-border bg-surface px-4 py-3 transition-colors hover:border-accent/50 focus-visible:border-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 active:scale-[0.99]"
                >
